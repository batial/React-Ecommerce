...
const Card = ({data}) => {
  ...
  return (
    <div className="bg-white cursor-pointer w-56 h-60 rounded-lg" onClick={()=>context.openItemDetail()}>
      <figure className="relative mb-2 w-full h-4/5">
        ...
        <button className="absolute top-0 right-0 flex justify-center items-center bg-white w-6 h-6 rounded-full m-2 pb-0.5 " onClick={()=> context.setCount(context.count + 1)}>
